...
└── screenshots/
    ├── 01-topology.png
    ├── 02-wazuh-server-vm-config.png
    ├── 03-windows-client-vm-config.png
    ├── 04-vboxnet0-network.png
    ├── 05-ubuntu-install-complete.png
    ├── 06-wazuh-installer-running.png
    ├── 07-wazuh-login-page.png
    ├── 08-wazuh-agent-running.png
    ├── 09-agent-active-dashboard.png
    ├── 10-brute-force-alerts.png
    ├── 11-powershell-privilege-escalation.png
    ├── 12-privilege-escalation-alerts.png
    └── 13-authentication-failures.png
